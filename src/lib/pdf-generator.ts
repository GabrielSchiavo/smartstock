...
// Receivers PDF Generator
export class ReceiversPdfGenerator extends BasePdfGenerator {
  constructor(
...
// Suppliers PDF Generator
export class SuppliersPdfGenerator extends BasePdfGenerator {
  constructor(
