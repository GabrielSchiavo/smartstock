  ...
  return (
    <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card grid grid-cols-1 gap-6 *:data-[slot=card]:shadow-xs @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      <Card className="bg-background! rounded-xl shadow">
        ...
        <CardFooter className="text-md text-muted-foreground flex-col items-start gap-1.5">
          <div className="line-clamp-1 flex gap-2">Total de produtos cadastrados</div>
        </CardFooter>
      </Card>
      <Card className="bg-background! rounded-xl shadow">
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
      ...
      <Card className="bg-background! rounded-xl shadow">
        ...
        <CardContent>
          <CardTitle className={cn(`text-4xl font-semibold tabular-nums @[250px]/card:text-3xl`)}>
      ...
      <Card className="bg-background! rounded-xl shadow">
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
          <CardTitle className="text-md text-muted-foreground font-medium">Fornecedores</CardTitle>
        ...
        <CardFooter className="text-md text-muted-foreground flex-col items-start gap-1.5">
          <div className="line-clamp-1 flex gap-2">Total de fornecedores cadastrados</div>
        </CardFooter>
      </Card>
    </div>
  );
