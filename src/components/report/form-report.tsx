...
import { FormReportsProps, LocaleType, ReportDataResponse, ReportType, ToastType } from '@/types';
      ...
      try {
        ...
        switch (values.reportType) {
          case ReportType.VALIDITY:
            response = await generateValidityReport(values.initialDate!, values.finalDate!);
            break;
          case ReportType.DONATIONS:
            response = await generateDonationsReport(values.initialDate!, values.finalDate!);
            break;
          case ReportType.PURCHASED:
            response = await generatePurchasedReport(values.initialDate!, values.finalDate!);
            break;
          case ReportType.RECEIVERS:
            response = await generateReceiversReport(values.initialDate!, values.finalDate!);
            break;
          case ReportType.SUPPLIERS:
            response = await generateSuppliersReport(values.initialDate!, values.finalDate!);
            break;
          case ReportType.INVENTORY:
            response = await generateInventoryReport();
            break;
          case ReportType.INPUTS:
            response = await generateInputsReport(values.initialDate!, values.finalDate!);
            break;
          case ReportType.OUTPUTS:
            response = await generateOutputsReport(values.initialDate!, values.finalDate!);
            break;
          case ReportType.ADJUSTMENTS:
            response = await generateAdjustmentsReport(values.initialDate!, values.finalDate!);
            break;
          default:
            showToast({
              title: 'Erro!',
                            ...
                            <ToolTipHelp>
                              <TooltipItem>
                                <p className="text-sm">
                                  ...
                                  - Gera um relatório de todos os items com suas respectivas
                                  validades em um determinado período
                                </p>
                              </TooltipItem>
                              <TooltipItem>
                                <p className="text-sm">
                                  ...
                                  - Gera um relatório de todos os items doados em um determinado
                                  período
                                </p>
                              </TooltipItem>
                              <TooltipItem>
                                <p className="text-sm">
                                  <span className="font-semibold">Comprados</span> - Gera um
                                  relatório de todos os items comprados em um determinado período
                                </p>
                              </TooltipItem>
                              <TooltipItem>
                                <p className="text-sm">
                                  <span className="font-semibold">
                                    {formatEnumValueDisplay(ReportType.RECEIVERS, 'capitalize')}
                                  </span>{' '}
                                  - Gera um relatório de todos os recebedores e seus items recebidos
                              ...
                              <TooltipItem>
                                <p className="text-sm">
                                  <span className="font-semibold">
                                    {formatEnumValueDisplay(ReportType.SUPPLIERS, 'capitalize')}
                                  </span>{' '}
                                  - Gera um relatório de todos os Fornecedores e seus items
                                  fornecidos em um determinado período
                                </p>
                              </TooltipItem>
                              <TooltipItem>
                                <p className="text-sm">
                                  ...
                                  - Gera um relatório de todos os produtos cadastrados no sistema em
                              ...
                              <TooltipItem>
                                <p className="text-sm">
                                  ...
                                  - Gera um relatório de todas as entradas em um determinado período
                                </p>
                              </TooltipItem>
                              <TooltipItem>
                                <p className="text-sm">
                                  ...
                                  - Gera um relatório de todas as saídas em um determinado período
                                </p>
                              </TooltipItem>
                              <TooltipItem>
                                <p className="text-sm">
                                  ...
                                  - Gera um relatório de todos os ajustes em um determinado período
                                </p>
                              </TooltipItem>
                            </ToolTipHelp>
                          </FormLabel>
                          <FormControl className="flex flex-col gap-3">
                            ...
                            >
                              <div className="grid grid-cols-1 items-start gap-3 sm:grid-cols-2">
                                ...
                                <FormItem className="flex items-center">
                                  <FormControl>
                                    <RadioGroupItem value={ReportType.DONATIONS} />
                                  </FormControl>
                                  <FormLabel className="font-normal">
                                    {formatEnumValueDisplay(ReportType.DONATIONS, 'capitalize')}
                                  </FormLabel>
                                ...
                                <FormItem className="flex items-center">
                                  <FormControl>
                                    <RadioGroupItem value={ReportType.PURCHASED} />
                                  </FormControl>
                                  <FormLabel className="font-normal">Comprados</FormLabel>
                                </FormItem>
                                <FormItem className="flex items-center">
                                  <FormControl>
                                    <RadioGroupItem value={ReportType.RECEIVERS} />
                                  </FormControl>
                                  <FormLabel className="font-normal">
                                    {formatEnumValueDisplay(ReportType.RECEIVERS, 'capitalize')}
                                  </FormLabel>
                                ...
                                <FormItem className="flex items-center">
                                  <FormControl>
                                    <RadioGroupItem value={ReportType.SUPPLIERS} />
                                  </FormControl>
                                  <FormLabel className="font-normal">
                                    {formatEnumValueDisplay(ReportType.SUPPLIERS, 'capitalize')}
                                  </FormLabel>
                                ...
                                <FormItem className="flex items-center">
                                  <FormControl>
                                    <RadioGroupItem value={ReportType.INVENTORY} />
                                  </FormControl>
                                  <FormLabel className="font-normal">
                                    {formatEnumValueDisplay(ReportType.INVENTORY, 'capitalize')}
                                  </FormLabel>
                                ...
                                <FormItem className="flex items-center">
                                  <FormControl>
                                    <RadioGroupItem value={ReportType.ADJUSTMENTS} />
                                  </FormControl>
                                  <FormLabel className="font-normal">
                                    {formatEnumValueDisplay(ReportType.ADJUSTMENTS, 'capitalize')}
                                  </FormLabel>
