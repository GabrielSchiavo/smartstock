        ...
        <div className="flex flex-col gap-12">
          <div className="flex flex-col gap-2">
            <div className="-mt-[7px] flex items-center gap-3">
              <h1 className="text-lg leading-none font-semibold">Editar Configurações da Conta</h1>
              <ToolTipHelp>
                <TooltipItem>
                  <p className="text-sm">
                    <span className="font-semibold">Alterar Senha</span> - Para alterar sua senha
                    informe a senha atual e a nova senha que deseja usar.
                  </p>
                </TooltipItem>
              </ToolTipHelp>
            </div>
            <p className="text-muted-foreground -mt-[7px] w-full text-sm md:max-w-md">
