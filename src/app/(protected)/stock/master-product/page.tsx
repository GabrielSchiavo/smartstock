...
import { ClientDataTableMasterProduct } from '@/components/tables/_clients/client-data-table-master-product';
          ...
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-2">
              <h1 className="text-lg leading-none font-semibold">
                <span className="flex items-center gap-3">Gerenciar Produto Mestre</span>
              </h1>
            ...
            <ClientDataTableMasterProduct masterProducts={masterProducts} />
          </div>
        </div>
      </div>
    </RoleGate>
